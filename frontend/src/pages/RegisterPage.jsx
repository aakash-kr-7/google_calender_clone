...
import { registerUser, loginGoogle } from '../api/client'
      ...
      <div className="bg-white rounded-3xl shadow-2xl flex max-w-4xl w-full overflow-hidden border border-slate-100 z-10 min-h-[600px]">
        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-600 p-12 text-white flex-col justify-between relative overflow-hidden">
          ...
          <div>
            ...
            <h2 className="text-3xl font-bold leading-tight mb-4">
              Join us to track <br />your events.
            </h2>
            <p className="text-blue-100/90 text-sm leading-relaxed max-w-xs">
              Create an account to test recurrence rules, overlapping alarms, and custom layout views.
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white relative">
          ...
          <div className="mb-6 text-center md:text-left">
            ...
            <p className="text-slate-500 text-sm mt-1.5">Sign up to get started.</p>
          </div>
          ...
          <div className="relative my-5 flex items-center justify-center">
            ...
            <span className="relative bg-white px-4 text-xs text-slate-400 font-medium uppercase tracking-wider">or sign up with email</span>
          </div>
